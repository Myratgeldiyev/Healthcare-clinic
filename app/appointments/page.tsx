...
export default function AppointmentsPage() {
	...
	const availableTimes =
		selectedDoctor && selectedDate
			? getAvailableTimes(selectedDoctor, selectedDate.toISOString())
			: []
					...
					<div className='mt-8 flex items-center justify-between'>
						{[1, 2, 3].map(s => (
							<div key={s} className='flex flex-1 items-center'>
								...
								{s < 3 && (
									<ChevronRight className='mx-2 h-5 w-5 flex-1 text-muted-foreground' />
								)}
							</div>
						))}
					</div>
									...
									>
										<Card>
											...
											<CardContent>
												...
												<div className='mt-6 flex flex-col w-full h-75 gap-2'>
													<Button
														variant='outline'
